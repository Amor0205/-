            ...
            <el-col :span="24">
                <el-table
                    ...
                    <template slot-scope="scope">
                        ...
                        <!-- <el-button type="warning"  size="small" @click="handleDelete(scope.$index, scope.row)">编辑</el-button> -->
...
<script>
    import {getMenuList} from '../../http/user'
export default {
    data(){
        return {
            queryInfo:{
            ...
            tableData: [
                {   
                    ...
                    // imgs: require('../../assets/image/login'), 
                    originaCost:50,
                    currentPrice:10,
                    gross :500,
                    inventory:10000,
                ...
                {   
                    ProductID:231321313,
                    name:'MTS5425韩版女童连衣裙2019秋新品网纱拼接连帽卫衣裙95-170CM',
                    imgs:'https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=3363295869,2467511306&fm=26&gp=0.jpg',
                    originaCost:50,
                    currentPrice:10,
                    gross :500,
                    inventory:10000,
